 ...
 */
 ...
 exports.findByCriteria = (parameter) => {
     return new Promise((resolve, rejected) => {
         ...
         /** define query to get all data */
         let query = `select * from ${tableName} where ${params} order by ${harga}`
 ...
 exports.add = (dataObject) => {
     return new Promise((resolve, rejected) => {
         ...
         /** result:
          * columns = 'jenis_telur, expired_date, stok, harga, jenis'
          * -----------------------------------------------
          */
 ...
 exports.update = (dataObject, parameter) => {
     return new Promise((resolve, rejected) => {
         ...
         let updateData = Object
             ...
             .join()
         /** result:
          * updateData = ' jenis_telur="Telur 1", expired_date="2023-01-01",
